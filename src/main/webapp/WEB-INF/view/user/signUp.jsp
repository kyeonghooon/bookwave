...
<script
	src="//cdnjs.cloudflare.com/ajax/libs/sockjs-client/1.5.1/sockjs.min.js"></script>
<script
...
<div class="d-flex justify-content-center mt-3">
	<div class="signup--container">
		...
		<form action="/user/sign-up" method="post"
			...
			<div class="form--group">
				<c:choose>
					<c:when test="${socialId != null }">
						...
						<input style="width: 81%" type="text" class="loginId"
							placeholder="아이디 입력" id="loginId" name="loginId" maxlength="12"
							readonly value="${socialId}" required />
				...
				<c:choose>
					<c:when test="${socialId != null }">
						...
						<input type="password" class="form--control" placeholder="비밀번호 입력"
							id="password" name="password" style="display: none;" readonly
			...
			<div class="form--group">
				<label for="zip">주소:</label> <input type="text" id="zip"
					style="width: 79%;" placeholder="우편번호" name="zip"
					readonly="readonly">
				<button type="button" class="btn btn-default" style="width: 19%"
			...
			<div class="d-flex w-100">
				<div class="form--group2">
					<label for="email">이메일:</label> <input type="text"
						...
						name="email1" required /> <span id="email2"
						class="input--group--text">@</span> <select name="email2">
				...
				<button type="button" id="send--email--verification"
					class="btn btn-primary">인증번호 전송</button>
			</div>
			<div class="p-2 d-flex justify-content-center">
				<input class="check" type="radio" name="gender" value="false"
					checked /> <span class="d-flex align-items-center ml-1 mr-1">
					남자 </span> <input class="check ml-3" type="radio" name="gender"
					value="true" /> <span class="d-flex align-items-center ml-1 mr-1">
					여자 </span>
			</div>
