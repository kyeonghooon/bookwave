    ...
    <div class="login--form--wrap">
      ...
      <div class="save_id_box">
        ...
        <div class="right_area">
          <a href="#" onclick="openWindow('id')"
            ><span class="text btn_text_id_link">아이디 찾기</span></a
          >
          <span class="gap">|</span>
          <a href="#" onclick="openWindow('pw')"
            ><span class="text btn_text_pw_link">비밀번호 찾기</span></a
          >
        </div>
      </div>
